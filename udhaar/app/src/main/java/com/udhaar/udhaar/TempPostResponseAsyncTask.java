...
/**
 * Created by Architkansal on 09-04-2016.
 */
...
public class TempPostResponseAsyncTask extends AsyncTask<String, Void, String> {
    ...
    //Constructor
    public TempPostResponseAsyncTask(AsyncResponse delegate){
    ...
    public TempPostResponseAsyncTask(AsyncResponse delegate, String loadingMessage){
        this.delegate = delegate;
        this.context = (Context)delegate;
